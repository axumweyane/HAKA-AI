...
**Proposal Number:** `[FILL: HAKA-PROP-YYYY-NNN]`

**Prepared For:** `[FILL: Client Organization Name]`

**Prepared By:** HAKA Security Consulting  
Owner & Principal Consultant: Tigray  

**Date:** `[FILL: Proposal Date]`
...
This proposal outlines a `[FILL: Engagement Type — e.g., External Vulnerability Assessment]` for **`[FILL: Client Name]`** . The engagement is designed to identify vulnerabilities in Internet-facing systems, assess their risk to the organization, and provide a prioritized remediation plan.

Our approach is informed by experience assessing `[FILL: Number — e.g., seven (7)]` major Ethiopian financial and telecom institutions, adherence to industry frameworks (NIST, OWASP, MITRE ATT&CK), and alignment with National Bank of Ethiopia cybersecurity directives.
...
**`[FILL: Engagement Type — External Vulnerability Assessment | Full Penetration Test | Quarterly Security Reassessment | Incident Response Retainer]`**
...
```
[FILL: List of in-scope domains, IP ranges, and systems]
e.g.:
- *.clientbank.com.et
...
All deliverables are provided in both **PDF** and **original format** (Markdown/CSV) within `[FILL: Days — e.g., five (5)]` business days of assessment completion.
...
|-----------|---------------|----------|
| **Project Kickoff** | `[FILL: Start Date]` | ½ day |
| **Reconnaissance & Scanning** | `[FILL: Start Date + 2 days]` | `[FILL: — e.g., 2–5 days]` |
| **Manual Validation** | `[FILL: Scanning end + 2 days]` | `[FILL: — e.g., 3–5 days]` |
| **Analysis & Report Drafting** | `[FILL: Validation end + 1 day]` | `[FILL: — e.g., 3–5 days]` |
| **Report Delivery** | `[FILL: Delivery Date]` | ½ day (walkthrough) |
| **Total Duration** | **`[FILL: — e.g., 2–3 weeks]`** | |
...
| Item | Amount (USD) |
|------|-------------|
| `[FILL: Engagement Type]` | **$`[FILL: Amount]`** |
| VAT (15%) — applicable only if VAT-registered | $`[FILL: VAT amount or 0]` |
| **Total** | **$`[FILL: Total]`** |
...
- Invoices are payable within `[FILL: — e.g., fifteen (15)]` calendar days
...
During the engagement and for `[FILL: — e.g., twelve (12)]` months thereafter, neither party shall solicit or hire the other party's personnel directly involved in the engagement without mutual written consent.
...
This proposal is valid for `[FILL: — e.g., thirty (30)]` calendar days from the date above.
...
### For [FILL: Client Organization Name]

```
Signature: ___________________________________
Name:      [FILL: Signatory full name]
